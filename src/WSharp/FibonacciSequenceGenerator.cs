...
9 defer (3 || 6) 1,3; 
		*/
		...
		private static ImmutableArray<Line> Generate() => 
			[
			 // 1 again (1) defer (3 || N(1)<=N(2) || N(7)>99) 2#N(1),3,7;
			 new Line(1, BigInteger.One, actions =>
				{
			   ...
			   // 2 again (2) defer (3 || N(2)<=N(1) || N(7)>99) 1#N(2),3,7;
			   new Line(2, BigInteger.One, actions =>
				{
			   ...
			   // 3 defer (5) print(N(1)+N(2));
			   new Line(3, BigInteger.One, actions =>
				{
			   ...
			   // 4 defer (5) print("1");
			   new Line(4, BigInteger.One, actions =>
				{
					actions.Defer(actions.E(5));
					if (!actions.ShouldStatementBeDeferred)
					{
			   ...
			   // 5 4,-3,7;
			   new Line(5, BigInteger.One, actions =>
				{
			   ...
			   // 6 defer (4) 3;
			   new Line(6, BigInteger.One, actions =>
				{
			   ...
			   // 7 7;
			   new Line(7, BigInteger.One, actions =>
				{
					actions.UpdateCount(7, BigInteger.One);
				}),
			   // 8 defer (N(7)<100) -1#N(1),-2#N(2),-7#100,-3;
			   new Line(8, BigInteger.One, actions =>
				{
			   ...
			   // 9 defer (3 || 6) 1,3; 
			   new Line(9, BigInteger.One, actions =>
				{
