...
public sealed class Parser
{
	...
	private CallExpressionSyntax ParseCallExpression()
	{
		...
		return new(this.Tree, identifier, openParenthesisToken, arguments, closeParenthesisToken);
	}
   ...
   private LiteralExpressionSyntax ParseNumberLiteralExpression() => 
		new(this.Tree, this.Match(SyntaxKind.NumberToken));
   ...
   private ParenthesizedExpressionSyntax ParseParenthesizedExpression()
	{
		...
		return new(this.Tree, left, expression, right);
	}
	...
	private LiteralExpressionSyntax ParseBooleanLiteralExpression()
	{
		...
		return new(this.Tree, keywordToken, isTrue);
	}

	private LiteralExpressionSyntax ParseStringLiteralExpression() =>
		new(this.Tree, this.Match(SyntaxKind.StringToken));
