...
public sealed class Evaluator
{
	...
	public ImmutableArray<Line> Evaluate()
	{
		...
		return [.. ((List<Line>)this.lastValue)];
	}
	...
	private BigInteger EvaluateUnaryUpdateLineCountExpression(IExecutionEngineActions? actions, BoundUnaryUpdateLineCountExpression unaryLine)
	{
	...
	private BigInteger EvaluateUpdateLineCountExpression(IExecutionEngineActions? actions, BoundUpdateLineCountExpression line)
	{
